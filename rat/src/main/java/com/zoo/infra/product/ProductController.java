...
////			for (int i=0; i<10; i++) {
////				
////				System.out.println("ifcgSeq : " + productService.selectList(productVo).get(i));
////			}
//			
...
//		}
//
//		@RequestMapping(value = "/v1/infra/product/productXdmInst")
...
//
//			return "redirect:/v1/infra/product/productXdmList";
...
//		}
//
//		@RequestMapping(value = "/v1/infra/product/productXdmMfom")
...
//		@RequestMapping(value = "/v1/infra/product/productXdmUpdate")
...
//		@RequestMapping(value = "/v1/infra/product/productXdmDelete")
...
//		@RequestMapping(value = "/v1/infra/product/productXdmUelete")
